...
function Home() {
  return (
    <div className='flex w-full  justify-between  relative lg:h-[700px]' >
      <div className="bg absolute top-0 w-full h-[90%] ">
        <img src={map} alt="" className='w-full h-full  lg:mt-10 object-cover' />
      </div>
      <div className="left w-[100%] px-3 lg:w-[50%] z-10 flex flex-col gap-5 justify-center items-center mx-auto h-[550px] ">
      ...
      <div className="right z-10 hidden lg:block">
        <img src={student} alt="" />
      </div>
    </div>
  )
